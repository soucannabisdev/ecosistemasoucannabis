        ...
        <Modal.Body>
          ...
          <form onSubmit={contact}>
            ...
            <div>
              ...
              {!type == "appointment" && (
                <h4 class="text-center text-contact "> Para solicitar contato, preencha seus dados abaixo e aguarde para ser atendido por nossa equipe de acolhimento</h4>
              )}

              <div className="mb-3">
                <label>Seu Nome</label>
                <input class="form-control" onBlur={handleChangeInput} onChange={handleChangeInput} value={formData.name} type="text" id="name" name="name" />
              </div>
              <div className="mb-3">
                <label>E-mail:</label>
                <EmailInput
            ...
            <br></br>
            {type == "appointment" && (
              <button class="btn btn-primary btn-lg" type="submit" onClick={contact}>Solicitar agendamento</button>
            )}

            {type != "appointment" && (
              <button class="btn btn-primary btn-lg" type="submit" onClick={contact}>Solicitar contato</button>
            )}
