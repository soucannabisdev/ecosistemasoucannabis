...
const LostPass = () => {
    ...
    async function submit() {
        await apiRequest("/api/email/lost-password", { "email": formData.email }, "POST")
            .then(response => {
            ...
            <Modal show={showPopup}  onHide={handleClose}>
                ...
                <Modal.Body>
                    ...
                    <form action="POST" >
                        ...
                        <a class="btn btn-success btn-lg btn-float-right" onClick={submit}>Redefinir senha</a>
                    </form>
                </Modal.Body>
            </Modal>
            <a onClick={lostPass} class="text-left text-white lost-pass">Esqueci minha senha</a>
        </div>
    );
};
