      ...
      <Formik initialValues={formData}>
        <Form onSubmit={contact} className="form-container">
          ...
          <div>
            ...
            <div className="mb-3">
              <PhoneInput className="form-control" placeholder="<-- Selecione o país | (DDD)Telefone" value={formData.phone} onChange={handleChangeInputPhone} name="phone" />
              <ErrorMessage name="phone" component="div" />
            </div>
          </div>

          <br></br>
          <button class="btn btn-primary btn-lg" type="submit" disabled={buttonDisabled} onClick={contact}>
            Solicitar contato
          </button>
          <button class="btn btn-success btn-lg btn-float-right" type="button" onClick={nocontact} value={2}>
